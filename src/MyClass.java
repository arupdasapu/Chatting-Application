...
public class MyClass implements ActionListener {
    ...
    MyClass() {
        ...
        JLabel profile = createIconLabel("icons/11.png", 50, 50, 40, 10, 50, 50);
        P1.add(profile);
        ...
        JLabel name = new JLabel("Arup(Me)");
        ...
        // Timer to refresh messages every 5 seconds (5000 ms)
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (!out.equals("")) {
                storeMessage("Arup(Me)", "Akash Sir", out);
